#!/bin/bash
# Interprets the commit message and says what should be done.
# That is, whether a new version of the code should be released,
# or just that the documentation should be rebuilt.
